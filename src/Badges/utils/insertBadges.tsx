...
import { BadgeId, UserProfileBadgeList } from "@discord/components";
...
export default function insertBadges(props: PropsFromFC<UserProfileBadgeList>, result: ReturnType<UserProfileBadgeList>) {
