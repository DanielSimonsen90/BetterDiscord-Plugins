...
export function insertBadges(props: PropsFromFC<BadgeList>, result: ReturnType<BadgeList>, badgeData: CustomBadgeData[]) {
  ...
  for (const [position, badge] of newBadges) {
    badges.splice(getPosition(position, badges), 0, badge as any);
  }
}
