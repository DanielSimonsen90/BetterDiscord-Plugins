/**
 * @name ExpandActivityStatus
 * @version 1.0.0
 * @author danhosaur
 * @authorLink https://github.com/danhosaur
 * @description Expand "Listening to Spotify" statuses into the details of the song being listened to.
 * @website https://github.com/DanielSimonsen90/BetterDiscord-Plugins
 * @source https://github.com/DanielSimonsen90/BetterDiscord-Plugins/tree/master/src/ExpandActivityStatus
**/
...
function afterUserActivityStatus() {
    after(UserActivityStatus, 'Z', ({ result, args: [props] }) => {
        ...
        try {
            ...
            error(err, { result, props, title, artists });
        }
    });
}
