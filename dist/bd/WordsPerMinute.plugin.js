...
const styles = "@charset \"UTF-8\";\n.PluginName-settings {\n  display: flex;\n  flex-direction: column;\n  gap: 1rem;\n}\n.PluginName-settings h3 {\n  font-size: 1.25rem;\n  font-weight: bold;\n  color: var(--header-primary);\n  margin-bottom: 0.5rem;\n}\n.PluginName-settings input {\n  box-sizing: border-box;\n  width: 100%;\n  padding: 0.25rem;\n  border: 1px solid var(--interactive-normal);\n  border-radius: 0.5rem;\n  font-size: 1rem;\n  background-color: var(--background-modifier-accent);\n  color: var(--text-normal);\n}\n.PluginName-settings .PluginName-highscores {\n  margin-top: 1rem;\n}\n.PluginName-settings .PluginName-highscores section {\n  display: grid;\n  grid-template-columns: repeat(2, 1fr);\n  gap: 1rem;\n  place-items: center;\n}\n.PluginName-settings .PluginName-highscores h3 {\n  font-size: 1.25rem;\n  font-weight: bold;\n  color: var(--header-primary);\n  margin-bottom: 0.5rem;\n  text-align: center;\n}\n.PluginName-settings .PluginName-highscores h3::after {\n  content: \"\";\n  display: block;\n  width: 100%;\n  height: 1px;\n  background-color: var(--background-modifier-accent);\n  margin-top: 0.5rem;\n}\n.PluginName-settings .PluginName-highscores h4 {\n  font-size: 1.2rem;\n  font-weight: bold;\n  color: var(--header-secondary);\n  margin-bottom: 0.5rem;\n}\n.PluginName-settings .PluginName-highscores p {\n  color: var(--text-normal);\n  font-size: 1rem;\n}\n.PluginName-settings .PluginName-highscores span:first-child {\n  font-weight: bold;\n}\n.PluginName-settings .PluginName-highscores span:last-child::before {\n  content: \" • \";\n}\n.PluginName-settings .PluginName-highscores button {\n  padding: 0.5rem;\n  font-size: 0.8rem;\n  border-radius: 0.5rem;\n  margin-inline: auto;\n  color: var(--button-danger-background) !important;\n}\n.PluginName-settings .PluginName-highscores button:hover {\n  color: var(--white-500) !important;\n}\n\nwpm-count {\n  display: none;\n  transition: top 0.25s ease-in-out 1s;\n}\n\nform:not(:has(span[class*=emptyText])) wpm-count {\n  --leftAlign: $defaultLeftAlign;\n  display: block;\n  color: var(--text-message-preview-low-sat);\n  font-size: 12px;\n  font-weight: bold;\n  position: absolute;\n  margin: 0;\n  top: 0.3rem;\n  left: var(--leftAlign, \"1.5rem\");\n}\n\nform:has(wpm-count) {\n  position: relative;\n}\n\ndiv[class*=inner]:has([class*=textArea] [data-slate-string]:not(:empty)) {\n  padding-top: 1rem;\n}";
...
const HighscoresGroup = ({ key }) => {
    const { best, bestDate, today, todayDate } = Highscores.useCurrent();
    const [value, date] = useMemo(() => key === 'best'
        ? [best, new Date(bestDate)]
        : [today, new Date(todayDate)], [key, best, bestDate, today, todayDate]);
    return (React.createElement("div", { className: `${PluginName}-${key}` },
        React.createElement("h3", null,
            key === 'best' ? 'Best' : `Today's`,
            " Highscore"),
        React.createElement("p", null,
            React.createElement("span", { id: `${PluginName}-${key}` },
                value,
                " wpm"),
            React.createElement("span", { id: `${PluginName}-${key}-date` }, date.toLocaleDateString()))));
};
    ...
    return (React.createElement("div", { className: `${PluginName}-settings`, style: { width: '100%' } },
        ...
        React.createElement("div", { className: `${PluginName}-highscores` },
            ...
            React.createElement("section", { className: `${PluginName}-highscores-container` },
                React.createElement(HighscoresGroup, { key: "best" }),
                React.createElement(HighscoresGroup, { key: "today" })),
