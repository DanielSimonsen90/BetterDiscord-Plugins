...
export default function EphemeralEye() {
    return (
        <svg className={window.BDFDB.DiscordClassModules.MessageLocalBot.icon} aria-hidden={false} width="16" height="16" viewBox="0 0 24 24">
