import { Channel, Guild, PermissionString, PresenceStoreState, Role, Snowflake } from "@discord";
...
export const GuildActions: GuildActions = Finder.byProps("requestMembers");
