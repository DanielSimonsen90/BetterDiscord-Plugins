...
export const alert = (title: string, content: string | React.JSX.Element): void => BdApi.UI.alert(title, content);

export type ConfirmOptions = BD.ConfirmationModalOptions;

/** Shows a confirmation modal. */
// TODO: change to promise<boolean>?
export const confirm = (title: string, content: string | React.JSX.Element, options: ConfirmOptions = {}): string => BdApi.UI.showConfirmationModal(title, content, options);
